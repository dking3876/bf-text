...
export class BfModal implements OnInit{
    ...
    ngOnInit(){
        ...
        this.mainContainer = this._element.nativeElement.childNodes[0];
        this.contentContainer = this.mainContainer.childNodes[0];
        this.closeContainer = this.mainContainer.childNodes[1];
        this.center();
    }
